            ...
            <table class="table table-hover mt-2">
                ...
                <tbody>
                    ...
                    <tr>
                       ...
                       <td>{{ $data->minat }}</td>
                       <td>
                       <a class="btn btn-outline-primary" href="/mahasiswa/formedit/{{ $data->id }}"><i class="bi bi-pencil-square"></i></i>Update</a>
                       <a class="btn btn-outline-danger" onclick="return confirm('Apakah yakin ingin menghapus ?')" href="/mahasiswa/hapusmhs/{{ $data->id }}"><i class="bi bi-trash-fill"></i></i>Delete</a>
