      ...
      <div class="container-fluid d-flex justify-content-center align-items-center vh-100">
        <div class="card w-50" >
            <div class="card-header bg-info d-flex justify-content-center">
                <strong>Form <span class="text-align text-light">Login</span></strong>
            </div>
            ...
            <div class="card-body">
                <form action="/ceklogin" method="POST">
                    ...
                    <div class="form-group d-flex justify-content-center">
                       <button class="btn btn-outline-primary" class="" type="submit">Sign-In</button>
                    </div>
                </form>
                <hr>
                <span class="text-align text-danger ">Belum Punya Akun?</span><a class="text-primary" href="/register">  Daftar Disini</a>
            </div>
        </div>
      </div>
    <!-- Optional JavaScript -->
